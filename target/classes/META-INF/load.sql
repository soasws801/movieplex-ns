INSERT INTO THEATERS("ID", "CAPACITY", "NAME", "ADDRESS") VALUES (1, 50, 'Cineplex Cinemas Scarborough', '300 Borough Dr, Scarborough, ON M1P 4P5')
INSERT INTO THEATERS("ID", "CAPACITY", "NAME", "ADDRESS") VALUES (2, 70, 'Cineplex Odeon', '785 Milner Ave, Scarborough, ON M1B 3C3')
INSERT INTO THEATERS("ID", "CAPACITY", "NAME", "ADDRESS") VALUES (3, 70, 'Woodside Square Cinemas', '1571 Sandhurst Cir, Scarborough, ON M1V 1V2')
INSERT INTO THEATERS("ID", "CAPACITY", "NAME", "ADDRESS") VALUES (4, 60, 'Cineplex Cinemas Fairview Mall', '1800 Sheppard Ave E, North York, ON M2J 5A7')
INSERT INTO THEATERS("ID", "CAPACITY", "NAME", "ADDRESS") VALUES (5, 120, 'Cineplex Cinemas Yorkdale', '3401 Dufferin St, North York, ON M6A 2T9')
INSERT INTO THEATERS("ID", "CAPACITY", "NAME", "ADDRESS") VALUES (6, 100, 'Cineplex Cinemas Empress Walk', '5095 Yonge St, North York, ON M2N 6Z4')
INSERT INTO THEATERS("ID", "CAPACITY", "NAME", "ADDRESS") VALUES (7, 80, 'Cineplex VIP Cinemas Don Mills', '12 Marie Labatte Rd, Toronto, ON M3C 0H9')
